...
@section('content')
    ...
    @include('manager.layouts.body.navbar')

    @include('manager.layouts.body.sidebar')
            ...
            <div class="card-body bg-gray-800 text-white pt-4">
                ...
                <div class="d-flex justify-content-center">
                    <a class="me-3" href="https://themesberg.com/product/admin-dashboard/volt-bootstrap-5-dashboard"
                        target="_blank">
                        <img src="{{ asset('v2/assets/img/technologies/bootstrap-5-logo.svg') }}" class="image image-xs">
                    </a>
