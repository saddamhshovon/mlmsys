   ...
   <div class="col-xl-6 col-md-6 mb-4">
      <div class="card shadow mb-4">
         <div class="card-body">
            ...
            <img class="rounded-circle" style="height:100px; width: 100px;" src="{{(!empty($homestart->image))?url('images/home/'.$homestart->image):url('images/no_image.jpg')}}" height="100%" width="100%" alt=""><br>
