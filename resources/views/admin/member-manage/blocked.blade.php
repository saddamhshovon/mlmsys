...
<div class="container-fluid">
   ...
   <!-- Page Heading -->
   <h1 class="h3 mb-2 text-gray-800">Blocked Members</h1>
                        ...
                        <tbody>
                           ...
                           <tr class="">
                              ...
                              <td class="text-center">
                                 @if(($mem->is_blocked)==1)
                                 <a href="{{route('member.is-blocked',$mem->id)}}" class="btn btn-danger btn-sm" title="Unblocked Now"><i class="fas fa-arrow-alt-circle-down"></i></i></a>
                                 @endif
