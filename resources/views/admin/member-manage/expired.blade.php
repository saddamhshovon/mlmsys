...
<div class="container-fluid">
   ...
   <!-- Page Heading -->
   <h1 class="h3 mb-2 text-gray-800">Expired members</h1>
                        ...
                        <tbody>
                           ...
                           <tr class="">
                              ...
                              <td class="text-center">
                                 ...
                                 @if(($mem->is_expired)==1)
                                 <button href="#" class="btn btn-warning btn-sm" title="Expired"><i class="fas fa-arrow-alt-circle-down"></i></i></button>
                                 @endif
                                 <a href="{{route('member.edit',$mem->id)}}" class="btn btn-primary btn-sm"><i class="fas fa-edit" title="Edit Data"></i></a>
                                 <a href="{{route('member.delete',$mem->id)}}" id="delete" class="btn btn-danger btn-sm" title="Delete Now"><i class="fas fa-trash-alt"></i></a>
                              </td>
                           </tr>
                           @endforeach
                        </tbody>
