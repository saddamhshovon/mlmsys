                                ...
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">We get it, stuff happens. Just enter your "username" below
                                            and we'll send you a email with a link to reset your password!</p>
                                    </div>
                                    @if(session('success'))
                                    ...
                                    <form class="user" action="{{route('reset')}}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="user_name" id="exampleInputUsername" aria-describedby="usernameHelp" placeholder="Enter Username...">
                                        </div>
