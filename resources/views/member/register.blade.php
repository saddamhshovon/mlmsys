                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('register.member') }}" method="POST">
                                ...
                                @enderror
                                <div class="form-group">
                                    <select class="form-control" aria-label="Select Membership Process"
                                        id="exampleMembershipProcess" placeholder="Membership Process"
                            ...
                            @if (session('success'))
                                <div class="form-group">
                                    <h1 id="memberThanks" class="h6 pl-3 mt-3 text-primary" role="alert">
                                        {{ session('success') }}</h1>
                                </div>
                            @endif
                            <hr>
